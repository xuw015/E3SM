...
set resolution     = conusx4v1_conusx4v1
set machine        = cori-knl
set walltime       = 00:30
setenv project       e3sm
#setenv project       m3213
...
set cime_dir = ${code_root_dir}/cime
...
#cp -r /global/homes/x/xuw015/wx_files/ZMnew_CAPE/* ${case_scripts_dir}/SourceMods/src.eam/
...
cat <<EOF >> user_nl_eam
 phys_nbrhd_degrees = 0.50d0
 phys_nbrhd_verbose = 2

 nhtfrq = 0, -3, -1
 mfilt  = 1,  8, 24
 avgflag_pertape = 'A','A','A'
 fexcl1 = 'AEROD_v','AODABS','AODABSBC','AODALL','AODBC','AODDUST','AODDUST1','AODDUST3','AODDUST4',
          'AODMODE1','AODMODE2','AODMODE3','AODMODE4','AODNIR','AODPOM','AODSO4','AODSOA','AODSS',
          'AODUV','AODVIS','AQ_DMS','AQ_H2O2','AQ_H2SO4','AQ_O3','AQ_SO2','AQ_SOAG','AREI','BURDEN1','BURDEN2','BURDEN3','BURDEN4','EXTINCT','H2O2_SRF','H2SO4_SRF','H2SO4_sfgaex1',
          'LINOZ_DO3','LINOZ_DO3_PSC','LINOZ_O3CLIM','LINOZ_O3COL','LINOZ_SSO3','LINOZ_SZA',
          'LND_MBL','O3','O3_SRF','SFH2O2','SFH2SO4','SFO3','SFSO2','SFSOAG','SFbc_a1',
          'SFbc_a3','SFbc_a4','SFdst_a1','SFdst_a3','SFmom_a1','SFmom_a2','SFmom_a3',
          'SFmom_a4','SFncl_a1','SFncl_a2','SFncl_a3','SFnum_a1','SFnum_a2','SFnum_a3',
          'SFnum_a4','SFpom_a1','SFpom_a3','SFpom_a4','SFso4_a1','SFso4_a2','SFso4_a3',
          'SFsoa_a1','SFsoa_a2','SFsoa_a3','SO2','SO2_CLXF','SO2_SRF','SOAG_CLXF','SOAG_SRF',
          'SOAG_sfgaex1','SSAVIS','SSTSFMBL','SSTSFMBL_OM','WD_H2O2','WD_H2SO4','WD_SO2',
          'aero_water','mlip','mom_a1DDF','mom_a1SF','mom_a1SFWET','mom_a1_SRF','mom_a1_sfgaex1',
          'mom_a2DDF','mom_a2SF','mom_a2SFWET','mom_a2_SRF','mom_a3DDF','mom_a3SFWET',
          'mom_a3_SRF','mom_a4DDF','mom_a4SF','mom_a4SFWET','mom_a4_SRF','mom_a4_sfgaex1',
          'mom_c1DDF','mom_c1SFWET','mom_c2DDF','mom_c2SFWET','mom_c3DDF','mom_c3SFWET',
          'mom_c4DDF','mom_c4SFWET','mpoly','mprot','ncl_a1DDF','ncl_a1SF','ncl_a1SFWET',
          ...
          'num_a1_CLXF','num_a1_SRF','num_a1_sfgaex1','num_a2DDF','num_a2SFWET','num_a2_CLXF',
          'num_a2_SRF','num_a3DDF','num_a3SF','num_a3SFWET','num_a3_SRF','num_a4DDF',
          'num_a4SFWET','num_a4_CLXF','num_a4_SRF','num_a4_sfgaex1','num_c1DDF','num_c1SFWET',
          'num_c2DDF','num_c2SFWET','num_c3DDF','num_c3SFWET','num_c4DDF','num_c4SFWET',
          'pom_a1DDF','pom_a1SFWET','pom_a1_SRF','pom_a1_sfgaex1','pom_a3DDF','pom_a3SFWET',
          'pom_a3_SRF','pom_a4DDF','pom_a4SFWET','pom_a4_CLXF','pom_a4_SRF','pom_a4_sfgaex1',
          'pom_c1DDF','pom_c1SFWET','pom_c3DDF','pom_c3SFWET','pom_c3SFWET','pom_c4DDF',
          'pom_c4SFWET','so4_a1DDF','so4_a1_CLXF','so4_a1_SRF','so4_a1_sfgaex1','so4_a2DDF',
          'so4_a2SFWET','so4_a2_CLXF','so4_a2_SRF','so4_a2_sfgaex1','so4_a3DDF','so4_a3SFWET',
          'so4_a3_SRF','so4_a3_sfgaex1','so4_c1DDF','so4_c1SFWET','so4_c1SFWET','so4_c2DDF',
          'so4_c2SFWET','so4_c3DDF','so4_c3SFWET','soa_a1DDF','soa_a1SFWET','soa_a1_SRF',
          'soa_a1_sfgaex1','soa_a2DDF','soa_a2SFWET','soa_a2_SRF','soa_a2_sfgaex1',
          'soa_a3DDF','soa_a3SFWET','soa_a3_SRF','soa_a3_sfgaex1','soa_c1DDF','soa_c1SFWET',
          'soa_c3DDF','soa_c3SFWET','soa_c3DDF','soa_c3SFWET','DF_DMS','DF_H2O2','DF_H2SO4',
          'DF_O3','DF_SO2','DF_SOAG','DMS_SRF','Mass_bc','Mass_dst','Mass_mom','Mass_ncl',
          'Mass_pom','Mass_so4','Mass_soa'
 
 fincl2 = 'CAPE','T','Q','U','V','OMEGA','PCONVB','PCONVT','PRECC',
          'PRECCDZM','PRECL','PRECSH','CMFMCDZM','CONCLD','CIN','CLDLOW','CLDMED','CLDHGH'
 fincl3 = 'CAPE','TS','PRECC','PRECL','CMFMCDZM'
EOF
